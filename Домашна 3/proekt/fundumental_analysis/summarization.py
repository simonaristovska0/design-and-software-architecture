...
def summarize_text(file_path, summarizer, max_length=130, min_length=30):
    ...
    summarized_text = summarizer(content, max_length=max_length, min_length=min_length, do_sample=False)[0]["summary_text"]
...
if __name__ == "__main__":
    # Use Hugging Face Hub directly without downloading the model locally
